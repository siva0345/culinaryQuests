...
import Country from '../Restaurants/ResSelectCountry'
          ...
          <div>
            ...
            <div className='carouselPart'>
              ...
              <Carousel.Item>
                ...
                <Carousel.Item>
                  <img className="d-block" src={india} alt="First slide"/>
                </Carousel.Item>
                <Carousel.Item>
                ...
                <Carousel.Item>
                    <img className="d-block" src={china} alt="Second slide"/>
                </Carousel.Item>
                <Carousel.Item>
                ...
                <Carousel.Item>
                    <img className="d-block" src={german} alt="Fifth slide"/>
                </Carousel.Item>
                <Carousel.Item>
